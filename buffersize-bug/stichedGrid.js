...
Xflow.registerOperator("xflow.stichedGrid", {
    ...
    alloc: function(sizes, lod , stitching,elevation)
    {
		...
		console.log('[' + stitching[0] + ' ' + stitching[1] + ' ' + stitching[2] + ' ' + stitching[3] + '] - alloc - ' + sizes['index']);
    },
    evaluate: function(position, normal, texcoord, index, lod, stitching, elevation) {
		...
		console.log('[' + stitching[0] + ' ' + stitching[1] + ' ' + stitching[2] + ' ' + stitching[3] + '] - evaluate - ' + index.length);
